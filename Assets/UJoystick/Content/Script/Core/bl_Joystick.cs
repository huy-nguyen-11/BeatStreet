...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [Header("Settings")]
    [SerializeField, Range(0.1f, 1)] private float Radio = 0.5f;//the ratio of the circumference of the joystick
    [SerializeField, Range(0.01f, 1f)] private float SmoothTime = 0.5f;//return to default position speed
    [SerializeField, Range(0.1f, 1)] private float OnPressScale = 0.5f;//return to default position speed
    public Color NormalColor = new Color(1, 1, 1, 1);
    public Color PressColor = new Color(1, 1, 1, 1);
    [SerializeField, Range(0.1f, 5)] private float Duration = 1f;
    ...
    [SerializeField] protected RectTransform floatingBackground; // Background of the floating joystick
