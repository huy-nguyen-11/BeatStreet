...
public class MG_DevGUI_GP : MonoBehaviour
{
    ...
    private void ShowPopupLandscape()
    {
        ...
        if (GUI.Button(btnPopupRect_21, "Win"))
        {
            HandleWin();
        }

        if (GUI.Button(btnPopupRect_22, "Full Mana"))
        {
            FullMana();
        }
        if (GUI.Button(btnPopupRect_23, "Immortal"))
        {
            SetImmortal();
        }
        if (GUI.Button(btnPopupRect_31, "Add Coin"))
        {
            AddCoin();
        }
        if (GUI.Button(btnPopupRect_32, "Add Diamont"))
        {
            AddDiamont();
        }
        if (GUI.Button(btnPopupRect_33, "Add Energy"))
        {
            FullEnergy();
        }
    ...
    private void ShowPopupLandscapeMini()
    {
        ...
        if (GUI.Button(btnPopupMediumRect_21, "Win"))
        {
            HandleWin();
        }

        if (GUI.Button(btnPopupMediumRect_22, "Lose"))
        {
            HandleLose();
        }
    ...
    private void ShowPopupPortrait()
    {
        ...
        if (GUI.Button(btnPopupPortraitRect_21, "Win"))
        {
            HandleWin();
        }

        if (GUI.Button(btnPopupPortraitRect_22, "Lose"))
        {
            HandleLose();
        }
    ...
    private void SetImmortal()
    {
        if (GamePlayManager.Instance != null)
        {
            ...
            {
                GamePlayManager.Instance._Player.isImmortal = !GamePlayManager.Instance._Player.isImmortal;
                Debug.Log("Immortal: " + GamePlayManager.Instance._Player.isImmortal);
            }
        }
    }
    ...
    private void AddDiamont()
    {
        Debug.Log("Add 1000 Diamont");
    ...
    {
        Debug.Log("Add Full Energy");
        PlayerPrefs.SetInt("Diamont", 20);
        if (GamePlayManager.Instance != null)
            GamePlayManager.Instance.gameOver.SetTopBar();
        // TODO: Logic Lose
    }
    ...
    {
        Debug.Log("Add Full Mana");
        if (GamePlayManager.Instance != null)
            GamePlayManager.Instance._Player.SetMana(100);
        // TODO: Logic Lose
    }
    #endregion
