...
public class ItemPlayer : MonoBehaviour
{
    ...
    [Header("Collection")]
    public float collectionHeightTolerance = 1.0f; // Tăng từ 0.5f để dễ nhặt hơn
    public float collectionDelay = 0.1f; // Thời gian chờ sau khi chạm đất trước khi có thể nhặt
